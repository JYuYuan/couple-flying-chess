...
import type { PlayerColor, WinTaskOption, CurrentTask } from '@/components/game/flying/types/game';
        ...
        >
          ...
          >
              ...
              <div className="flex items-center justify-center space-x-3 mb-2">
                <motion.div
                  ...
                  className={`p-3 rounded-full border-2 ${
                    winner === 'red'
                      ? 'bg-gradient-to-br from-red-100 to-pink-200 border-red-200'
                      : 'bg-gradient-to-br from-blue-100 to-cyan-200 border-blue-200'
                  } ${
                    theme === 'dark'
                      ? winner === 'red'
                        ? 'dark:from-red-900/30 dark:to-pink-900/30 dark:border-red-700/50'
                        : 'dark:from-blue-900/30 dark:to-cyan-900/30 dark:border-blue-700/50'
                      : ''
                  }`}
                >
              ...
              <div className="text-center">
                <div
                  className={`inline-flex items-center px-4 py-2 rounded-full font-bold text-sm transition-colors duration-300 ${
                    ...
                    theme === 'dark'
                      ? winner === 'red'
                        ? 'dark:from-red-900/40 dark:to-pink-900/40 dark:text-red-300 dark:border-red-700/50'
                        : 'dark:from-blue-900/40 dark:to-cyan-900/40 dark:text-blue-300 dark:border-blue-700/50'
                      : ''
                  }`}
                >
                  <motion.div
            ...
            <div className="p-6 space-y-6">
              ...
              {/* 庆祝消息 */}
              <div
                className={`flex items-center justify-center space-x-3 p-4 rounded-xl border transition-colors duration-500 ${
                  theme === 'dark'
              ...
              >
                ...
                <p
                  className={`text-center font-medium transition-colors duration-500 ${
            ...
            >
              <div className="flex space-x-4">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  onClick={onRestart}
                  className={`relative z-10 flex-1 font-bold py-4 px-6 rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl ${
                    theme === 'dark'
