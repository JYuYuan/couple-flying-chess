...
export default function StructuredData() {
  ...
  const organizationStructuredData = {
    ...
    alternateName: ['Love Flight Chess', 'ラブフライトチェス'],
    url: 'https://cpflying.vercel.app',
    logo: 'https://cpflying.vercel.app/images/logo.png',
    description: '专注于情侣互动游戏开发，致力于为情侣提供增进感情的创意游戏体验',
    sameAs: ['https://cpflying.vercel.app'],
    address: {
      '@type': 'PostalAddress',
      addressCountry: 'CN',
    },
  ...
  const softwareApplicationData = {
    ...
    screenshot: 'https://cpflying.vercel.app/images/screenshot.jpg',
    video: 'https://cpflying.vercel.app/videos/gameplay.mp4',
